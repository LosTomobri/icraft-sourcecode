...
public final class CallSounds {

    private static final String FOLDER = "sounds/calls";
    ...
    public static synchronized List<String> getAvailable() {
        ...
        try {
            ...
            ICraftConstants.LOGGER.warn("No se pudieron listar los sonidos de llamada", e);
        }
    ...
    public static void play(String name) {
        ...
        ResourceLocation id = ResourceLocation.fromNamespaceAndPath(ICraftConstants.MODID, "call." + name);
    ...
    public static void stopRing() {
        if (currentPreview != null) {
            Minecraft.getInstance().getSoundManager().stop(currentPreview);
            currentPreview = null;
        }
    }
    ...
    public static boolean isPlaying() {
        ...
        return Minecraft.getInstance().getSoundManager().isActive(currentPreview);
    }
}
